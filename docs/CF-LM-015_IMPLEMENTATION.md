...
The original preregistered trajectory `[0, 0.029847395483642875, 0.029847395483642875, 0.022385546612732156, 0.014923697741821437]` is therefore the isolated-substrate special case (steps 0-2, before member feedback arrives). The corrected frozen trajectory is the full-coupled prediction:
